    ...
    //  "Bernd" -> 3465081
    //  "Ludolf" -> 3985ß29
    val telefonNummerListe: Map<String, Int> = mapOf("Peter" to 2487503, "Bernd" to 3465081, "Ludolf" to 3985029)
    ...
    println("${personZuTelefonnummer} + ${telefonNummerListe} + ${stringZuInt}")
